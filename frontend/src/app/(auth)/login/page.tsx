    ...
    <div className="min-h-screen bg-page flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold t1">Sign in to Archon</h1>
          <p className="t3 mt-1">AI System Auditor</p>
        </div>
        ...
        <p className="text-center t3 text-sm mt-4">
          No account?{" "}
          <Link href="/register" className="text-archon-400 hover:text-archon-300">Register</Link>
        </p>
      </div>
    </div>
  )
